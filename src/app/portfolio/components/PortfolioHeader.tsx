...
export default function PortfolioHeader(props: Props) {
  ...
  return (
    <div className="flex items-center justify-between mb-8">
      <div>
        <h1 className="text-8xl font-bold text-white font-[hagrid-text]">
          {isAllCalculated ? (
        ...
        <div className="mt-4 flex space-x-8 text-sm font-[hagrid-text]">
      ...
      <div className="flex items-center space-x-4">
        <span className="text-white text-lg font-medium font-[hagrid-text]">
          Currency:
        </span>
        <div className="flex bg-gray-700 rounded-lg p-1">
          <button
            onClick={() => onSelectCurrency("USD")}
            className={`px-4 py-2 rounded-md font-medium transition-colors font-[hagrid-text] ${
        ...
        <div
          className="text-xs text-gray-400 font-[hagrid-text]"
        ...
        {lastPriceUpdate && (
          <div className="text-xs text-gray-500 font-[hagrid-text]">
